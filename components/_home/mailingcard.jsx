...
export const MailingCard = () => {
    ...
    return (
        <div className={` flex flex-row items-center justify-center p-10 gap-15 mailingcard_container`}>
            <div className={`w-2/5 text-base text-neutral-300 comfortaa-font mailingcard_text `}>
                Join our mailing list to receive the latest news and updates from our team.
                Get 20% off your first order!
            </div>
            <div className={`w-2/5 flex flex-row items-center justify-between border-[0.6px] border-neutral-600 rounded-md focus-within:border-neutral-300 mailingcard_input`}>
